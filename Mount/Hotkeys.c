...
GSTHOTKEY	Hotkeys [NBR_HOTKEYS];
static GSTHOTKEY	tmpHotkeys [NBR_HOTKEYS];
...
static BOOL ShortcutInUse (UINT vKeyCode, UINT modifiers, GSTHOTKEY hotkeys[])
{
	int i;
...
void UnregisterAllHotkeys (HWND hwndDlg, GSTHOTKEY hotkeys[])
{
	int i;
...
BOOL RegisterAllHotkeys (HWND hwndDlg, GSTHOTKEY hotkeys[])
{
	BOOL result = TRUE;
	int i;
